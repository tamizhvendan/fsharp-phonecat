...
module PromotionsTests =     
    ...
    let ``getPromotions returns phones with age less than 3 `` () =
        let phoneIndexes : seq<PhoneIndexTypeProvider.Root> = seq {
            yield new PhoneIndexTypeProvider.Root(0, "id0", "imageUrl0", "name0", "snippet0", Some "carrier0")
            yield new PhoneIndexTypeProvider.Root(1, "id1", "imageUrl1", "name1", "snippet1", Some "carrier1")
            yield new PhoneIndexTypeProvider.Root(2, "id2", "imageUrl2", "name2", "snippet2", Some "carrier2")
            yield new PhoneIndexTypeProvider.Root(3, "id3", "imageUrl3", "name3", "snippet3", Some "carrier3")
            yield new PhoneIndexTypeProvider.Root(4, "id4", "imageUrl4", "name4", "snippet4", Some "carrier4")
        }
